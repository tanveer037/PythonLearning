...
while player1_bet == "rock" or player1_bet == "paper" or player1_bet == "scissors":
    if not(player2_bet == "rock" or player2_bet == "paper" or player2_bet == "scissors"):
        player2_bet = input(f"Invalid input, enter your bet, {player2} : ")
    elif player1_bet == "rock" and player2_bet == "scissors":
